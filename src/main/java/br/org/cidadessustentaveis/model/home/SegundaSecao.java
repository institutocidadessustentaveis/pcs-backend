...
@Entity
@Table(name="home_segunda_secao")	
@Getter @Setter @NoArgsConstructor @AllArgsConstructor
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"}) 
@EntityListeners(ListenerAuditoria.class)
@Indexed
public class SegundaSecao implements Serializable{


	private static final long serialVersionUID = 1L;
	
	@Id @GeneratedValue(generator = "home_segunda_secao_id_seq")
	@SequenceGenerator(name = "home_segunda_secao_id_seq", sequenceName = "home_segunda_secao_id_seq", allocationSize = 1)
