...
@Entity
@Table(name="home_quinta_secao")	
@Getter @Setter @NoArgsConstructor @AllArgsConstructor
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"}) 
@EntityListeners(ListenerAuditoria.class)
@Indexed
public class QuintaSecao implements Serializable{


	private static final long serialVersionUID = 1L;
	
	@Id @GeneratedValue(generator = "home_quinta_secao_id_seq")
	@SequenceGenerator(name = "home_quinta_secao_id_seq", sequenceName = "home_quinta_secao_id_seq", allocationSize = 1)
	...
	@Column(name="primeiro_sub_titulo")
	@Field(index=Index.YES, termVector = TermVector.YES,store=Store.YES)
	@Analyzer(definition = "analyzers")
	private String primeiroSubTitulo;
	
	@Column(name = "primeiro_sub_titulo_cor")
	private String primeiroSubTituloCor;

	@Column(name = "primeiro_sub_titulo_link")
	...
	@Column(name="segundo_sub_titulo")
	@Field(index=Index.YES, termVector = TermVector.YES,store=Store.YES)
	@Analyzer(definition = "analyzers")
	private String segundoSubTitulo;
		
	@Column(name = "segundo_sub_titulo_cor")
	private String segundoSubTituloCor;

	@Column(name = "segundo_sub_titulo_link")
