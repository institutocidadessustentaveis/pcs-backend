...
@Entity
@Table(name="home_setima_secao")	
@Getter @Setter @NoArgsConstructor @AllArgsConstructor
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"}) 
@EntityListeners(ListenerAuditoria.class)
@Indexed
public class SetimaSecao implements Serializable{


	private static final long serialVersionUID = 1L;
	
	@Id @GeneratedValue(generator = "home_setima_secao_id_seq")
	@SequenceGenerator(name = "home_setima_secao_id_seq", sequenceName = "home_setima_secao_id_seq", allocationSize = 1)
