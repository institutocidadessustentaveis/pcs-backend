...
@Table(name="comentario_discussao_filho", schema = "public")
public class ComentarioDiscussaoFilho implements Serializable {
...
private static final long serialVersionUID = -1635819021965912891L;
	...
	@ManyToOne(fetch= FetchType.LAZY)
	@JoinColumn(name="comentario_pai", nullable = false)
	private ComentarioDiscussao comentarioPai;
