...
public class SextaSecaoDTO implements Serializable{
...
private static final long serialVersionUID = 1L;
	...
	public SextaSecaoDTO(Long id, Long indice, String tituloPrincipal, Boolean exibir, String tipo) {
		this.id = id;
		this.indice = indice;
	...
	public SextaSecaoDTO(SextaSecao obj) {
		this.id = obj.getId();
	...
	public SextaSecao toEntityInsert() {	
		SextaSecao objToInsert = new SextaSecao();
	...
	public SextaSecao toEntityUpdate(SextaSecao objRef) {
    ...
    public static SextaSecaoDTO create(SextaSecao sextaSecao) {
        ModelMapper modelMapper = new ModelMapper();
        return modelMapper.map(sextaSecao, SextaSecaoDTO.class);
    }
