...
public class ExibirCidadeProvinciaEstadoDTO implements Serializable {
	...
	public ExibirCidadeProvinciaEstadoDTO(Cidade cidade) {
		...
		this.fotoCidade = cidade.getFotoCidadeDefault();
	...
	public ExibirCidadeProvinciaEstadoDTO(Long id, String nome) {
		this.id = id;
		this.nome = nome;
	}
