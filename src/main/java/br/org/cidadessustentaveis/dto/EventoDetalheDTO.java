...
public class EventoDetalheDTO {
	...
	public EventoDetalheDTO(Evento evento) {
		...
		this.eixos = evento.getEixos() != null ? evento.getEixos() : null;
	...
	public EventoDetalheDTO(Long id, String tipo, String nome, LocalDate data, LocalTime horario, boolean publicado, String endereco, String descricao, String site, Double latitude, Double longitude) {
		this.id = id;
		this.tipo = tipo;
		this.nome = nome;
		this.data = data;
	...
	public Evento toEntityInsert(EventoDetalheDTO evento) {
	...
	public EventoDetalheDTO(Long id, String tipo, String nome) {
		this.id = id;
		this.tipo = tipo;
		this.nome = nome;
	}
	
	public EventoDetalheDTO(Long id, LocalDate dataEvento, String tipo,
