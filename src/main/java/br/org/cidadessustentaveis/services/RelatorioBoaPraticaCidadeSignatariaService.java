...
@Service
public class RelatorioBoaPraticaCidadeSignatariaService {
    ...
    public List<RelatorioBoaPraticaCidadeSignatariaDTO> buscarRelatorios(String titulo, Long idPais, Long idEstado, Long idCidade, Long idEixo, Long idOds, Long idMetaOds) {

		CriteriaBuilder cb = em.getCriteriaBuilder();

		CriteriaQuery<RelatorioBoaPraticaCidadeSignatariaDTO> query = cb.createQuery(RelatorioBoaPraticaCidadeSignatariaDTO.class);
		...
		Predicate predicateForTipo = cb.equal(boaPratica.get("tipo"), "Prefeitura");
		...
		TypedQuery<RelatorioBoaPraticaCidadeSignatariaDTO> typedQuery = em.createQuery(query);
		List<RelatorioBoaPraticaCidadeSignatariaDTO> lista = typedQuery.getResultList();
